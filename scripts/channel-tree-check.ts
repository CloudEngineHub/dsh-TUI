...
// entries.
{
  ...
  // its per-log allowance is min(4×199600+4096, 803746) = 802496 — the flood
  // must outlast BOTH caps, with the real events behind it never reached.
  writePlainLog('s-noisy1', [HEADER, ...flood(802_600), ...mkTurns(0, 50, 'noisy1')])
  // s-noisy1 leaves the budget at 803746-802497 = 1249; a second, small flood
  // (≥1249 envelopes) drains the rest.
